      ...
      <div className=" container mx-auto px-5 py-10 md:py-14">
        <div className="flex flex-wrap -m-4 text-center">
          <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
            <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-300 bg-white shadow-md px-4 py-6 rounded-lg">
            <FaTshirt className="w-12 h-12 mb-3 inline-block"/>
          ...
          <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
          <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-300 bg-white shadow-md px-4 py-6 rounded-lg">
          <FaTruck className="w-12 h-12 mb-3 inline-block "/>
          ...
          <div className="p-4 md:w-1/3 sm:w-1/2 w-full">
          <div className="border-2 hover:shadow-xl hover:shadow-gray-200 border-gray-300 bg-white shadow-md px-4 py-6 rounded-lg">
          <SiRazorpay  className="w-12 h-12 mb-3 inline-block"/>

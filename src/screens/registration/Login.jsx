...
const Login = () => {
    ...
    function register (email, password) {
      ...
      getDoc(doc(fireDB, "user",user.uid)).then((res)=>{
        console.log(res);
        ...
        // if ((data.name = "admin" && data.user.email === "mhdrafix2@gmail.com")) {
              ...
              <div className="mt-12 flex flex-col items-center">
                <div className="w-full flex-1 mt-8">
                  ...
                  <div className="mx-auto max-w-xs">
                    ...
                    <button 
                    type="button"
                    onClick={()=>register(loginEmail.current.value,loginPassword.current.value)}
                    ...
                    <Link to={"/signup"}>Don't have an acount? <span className=" text-blue-600">SignUp</span></Link>

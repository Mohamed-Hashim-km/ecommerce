...
<div
    ...
    <div className="w-full">
        <div className="text-center">
            <h1 className="text-3xl font-semibold text-orange-800">Login</h1>
        ...
        <div className="mt-5">
            <form action="">
                ...
                <div className="relative mt-6">
                    <input ref={password} type="password"  placeholder="Password" className="peer peer mt-1 w-full border-b-2 border-gray-300 px-0 py-1 placeholder:text-transparent focus:border-gray-500 focus:outline-none" />
                ...
                <div className="my-6">
                    <button onClick={() => LoginHandler(email.current.value, password.current.value)} type="button" className="w-full rounded-md bg-orange-700 px-3 py-4 text-white focus:bg-orange-9000 focus:outline-none">Login</button>
                </div>
                <p className="text-center text-sm text-gray-500">Don&#x27;t have an account yet?
                    <Link to={"/signup"}><a 
                        className="font-semibold text-orange-700 hover:underline focus:text-gray-800 focus:outline-none"> Sign
                        up
                    </a>.</Link>
                </p>
            </form>

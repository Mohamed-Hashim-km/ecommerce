                ...
                <form action="">
                  ...
                  <div className="my-6">
                    <button
                      ...
                      type="button"
                      className="w-full rounded-md bg-orange-700 px-3 py-4 text-white focus:bg-orange-9000 focus:outline-none"
                    >
                      Login
                    </button>
                  </div>
                  <p className="text-center text-sm text-gray-500">
                    ...
                    <Link to={"/signup"}>
                      <a className="font-semibold text-orange-700 hover:underline focus:text-gray-800 focus:outline-none"> Sign up</a>.
                    </Link>
                  </p>
                </form>
              </div>
